...
/*<applet code ="Question1.class" width=200 height=300>
  </applet>
  */
  public class Question1 extends Applet implements ActionListener
  {
    TextArea txt;
    Button b1, b2, b3, b4;
    String s1, s2;
    ...
    public void init()
    {
      ...
      b1 = new Button("Count no of Vowels");
      add(b1);
      b1.addActionListener(this);
      t1 = new TextField(10);
      add(t1);

      b2 = new Button("Count no of Consonants");
      add(b2);
      b2.addActionListener(this);
      t2 = new TextField(10);
      add(t2);

      b3 = new Button("Count no of Punctuations");
      add(b3);
